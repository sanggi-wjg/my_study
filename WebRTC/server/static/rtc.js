...
const fileInput = document.querySelector('input#fileInput'),
    sendFileButton = document.querySelector('button#sendFileButton'),
    abortButton = document.querySelector('button#abortButton'),
    downloadAnchor = document.querySelector('a#download'),
    sendProgressBar = document.querySelector('progress#sendProgressBar'),
    receiveProgressBar = document.querySelector('progress#receiveProgressBar'),
    statusMessage = document.querySelector('span#statusMessage'),
...
async function createConnection()
{
    ...
    console.log('Create local peer connection object');

    sendChannel = localConnection.createDataChannel('sendDataChannel');
    sendChannel.binaryType = 'arraybuffer';
    console.log('Create send data channel');
    ...
    try {
        ...
        console.error('Failed to crate session description', e)
    }
...
function sendData()
{
    ...
    receiveProgressBar.max = file.size;
...
function onReceiveMessageCallback(event)
{
    ...
    receiveProgressBar.value = receivedSize;
...
function onError(error)
{
    ...
    console.error('Error in sendChannel which is already closed:', error);
}
